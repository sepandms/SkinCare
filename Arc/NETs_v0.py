...
class CNN_Nets:
    class Net1(nn.Module):
        def __init__(self,drop_out=0.2,fc_features=1100):
            super().__init__()
            ...
            self.fc1   = nn.Linear(in_features= fc_features , out_features = 512)
    ...
    class Net3(nn.Module):
        def __init__(self,drop_out=0.2,fc_features=1100):
            ...
            self.pool2 = nn.MaxPool2d( kernel_size = (3,3), stride = 2, padding = 0 )
            self.fc1   = nn.Linear(in_features= fc_features , out_features = 256)
    ...
    class Net5(nn.Module):
        def __init__(self,drop_out=0.2,fc_features=1100):
            ...
            self.pool1 = nn.MaxPool2d( kernel_size = (3,3), stride = 2, padding = 0 )
            self.fc1   = nn.Linear(in_features= fc_features , out_features = 7)
            self.Act   = nn.LeakyReLU(inplace=True)
    ...
    class Net7(nn.Module):
        def __init__(self,drop_out=0.2,fc_features=1100):
            ...
            self.fc1   = nn.Linear(in_features= fc_features , out_features = 128)
    ...
    class Net11(nn.Module):
        def __init__(self,drop_out=0.2,fc_features=1100):
            ...
            self.fc1 = nn.Linear(fc_features, 140)
